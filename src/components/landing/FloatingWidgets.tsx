...
export const FloatingWidgets = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-3">
      ...
      <button
        onClick={scrollToTop}
        className={`w-12 h-12 rounded-full bg-white border border-primary/10 text-primary hover:bg-accent hover:text-white hover:border-transparent flex items-center justify-center shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1 ${
