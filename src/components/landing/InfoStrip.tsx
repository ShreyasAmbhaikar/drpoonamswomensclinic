          ...
          <div className="flex flex-col md:flex-row items-center gap-[40px] w-full md:w-auto">
            ...
            <div className="flex items-center gap-[20px] w-full md:w-auto">
              ...
              <div>
                ...
                <a href="tel:09711929529" className="text-[20px] md:text-[24px] font-bold text-primary hover:text-accent transition-colors duration-300">
                  Call on : 097119 29529
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-[20px] w-full md:w-auto">
              ...
              <div>
                ...
                <h4 className="text-[17px] font-bold text-primary whitespace-nowrap">
                  Mon to Sat 10am - 2pm, 6pm - 9pm
                </h4>
              </div>
            </div>
