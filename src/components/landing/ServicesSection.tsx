...
const SERVICES = [
  {
    ...
    description: "Expert prenatal care, labor monitoring, and natural childbirth assistance tailored for mother and baby.",
    icon: (
  ...
  },
  {
    ...
    description: "Safe, sterile, and professional surgical childbirth options when medically indicated.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="currentColor">
  ...
  },
  {
    ...
    description: "Expert fertility diagnostics, follicle tracking, Intrauterine Insemination, and IVF guidance.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="currentColor">
        <path d="M36.4783 4.53125H11.4979C10.8049 4.5503 10.1261 4.7325 9.51642 5.0625C8.91091 5.39019 8.38995 5.85451 7.99591 6.41895L1.75666 15.0596C1.19205 15.8565 0.912803 16.8122 0.957829 17.7803C1.00291 18.7483 1.37 19.6735 2.0008 20.4092L20.7235 41.9785C21.1103 42.467 21.6011 42.8635 22.161 43.1377C22.733 43.4178 23.3619 43.5635 23.9988 43.5635C24.6358 43.5634 25.2647 43.4179 25.8367 43.1377C26.4053 42.8592 26.9033 42.4551 27.2928 41.9561L45.994 20.4131C46.6276 19.6735 46.9948 18.7482 47.0399 17.7803C47.0849 16.8121 46.8048 15.8566 46.2449 15.0654L40.0008 6.41895C39.6068 5.85471 39.0866 5.39014 38.4813 5.0625C37.8715 4.7325 37.1919 4.55028 36.4783 4.53125Z"></path>
      </svg>
    ),
